...
var arry = [];
class Vehicles {
    constructor(image, model, wheels, seatNumber, id) {
        this.image = image;
        this.model = model;
        this.wheels = wheels;
    ...
    cardGeneral() {
        document.getElementById("grid").innerHTML += `<div class="col-lg-3"><div class="card" style="width: 18rem;">
...
class Motorbike extends Vehicles {
    constructor(image, model, wheels, seatNumber, id, fType, kmLeft) {
...
class Truck extends Vehicles {
    constructor(image, model, wheels, seatNumber, id, fType, description) {
        super(image, model, wheels, seatNumber, id);
        this.image = image;
        this.model = model;
        this.wheels = wheels;
...
for (let index = 0; index < arry.length; index++) {
    let d = document.getElementsByClassName("my-price")[index];
    d.addEventListener("click", function () {
        document.getElementsByClassName("my-message")[index].innerHTML = arry[index].price();
    });
}
